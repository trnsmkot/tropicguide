...
//  TropicGuide
//
//  Created by Vladislav Kasatkin on 27.09.2020.
//  Copyright © 2020 Vladislav Kasatkin. All rights reserved.
//
...
class TopCategoriesViewController: BaseTableViewController<PointCategoryTableViewCell> {
    ...
    override func viewDidLoad() {
        ...
        spinner.start()
        PointViewModal.shared.getTopCategories()?
